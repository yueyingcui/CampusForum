...
public class ModifyPostS extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String query1 = "UPDATE POST SET CONTENT = '" + content +"' WHERE POSTID = '" + postid + "'";
			System.out.println(query1);
			stmt1.executeUpdate(query1);
			// querry2: update POST
			String query2 = "UPDATE POST SET DATETIME = '" + datetime + "' WHERE POSTID = '" + postid + "'";
