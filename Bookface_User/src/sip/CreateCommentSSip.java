...
public class CreateCommentSSip extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			// querry1: insert SIPCOMMENT
			// get primary key +1
			Statement stmt1 = conn.createStatement();
			String query1 = "SELECT SIPCOMMENTID FROM SIPCOMMENT";
			...
			// (querry2)
			String query2 = "INSERT INTO SIPCOMMENT (SIPCOMMENTID, OWNERID, CONTENT, DATETIME, SIPPOSTID) VALUES ('" + commentid_db + "', '" + comment_ownerid + "', '" + content + "', '" + datetime + "', '" + postid + "')";
