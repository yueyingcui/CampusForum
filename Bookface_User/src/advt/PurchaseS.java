...
public class PurchaseS extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("-----advt/PurchaseS.java | Advt/purchase.jsp-----");
		try{
			// JSP information
			response.setContentType("text/html; charset=gbk");
			String numberofunit = request.getParameter("numberofunit");
			System.out.println("numberofunit: " + numberofunit);
			String advertisementid_choose = request.getParameter("advertisementid_choose");
			...
			// querry1: insert TRANSACTION
			// get primary key +1
			Statement stmt1 = conn.createStatement();
			String query1 = "SELECT TRANSACTIONID FROM TRANSACTION";
			...
			transactionid_db = transactionid_db + 1;
				
			// (querry2)
			String query2 = "INSERT INTO TRANSACTION (TRANSACTIONID, DATETIME, ADVERTISEMENTID, NUMBER_OF_UNITS, USERID) VALUES ('" + transactionid_db + "', '" + datetime + "', '" + advertisementid_choose + "', '" + numberofunit + "', '" + hostid + "')";
