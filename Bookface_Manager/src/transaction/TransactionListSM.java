...
public class TransactionListSM extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String submit_listbymonth = request.getParameter("listbymonth");
		...
		if(submit_listbyitem != null)
		{
			try{
				...
				String query1 = "SELECT ADVERTISEMENTID, ITEMNAME FROM ADVERTISEMENT";
				...
				request.getRequestDispatcher("jsp/Transaction/tlitemlistM.jsp").forward(request,response);
		...
		if(submit_listbymonth != null)
		{
			System.out.println("Show months!");
			response.sendRedirect("jsp/Transaction/tlmonthlistM.jsp");
		}
		...
		if(submit_listbycustomer != null)
		{
			try{
				...
				request.getRequestDispatcher("jsp/Transaction/tlcustomerlistM.jsp").forward(request,response);
